...
def audit_payload() -> dict:
    return {
        ...
        "migration_before": env("KAZA_AUDIT_MIGRATION_BEFORE"),
        "migration_after": env("KAZA_AUDIT_MIGRATION_AFTER"),
        ...
        "image_ids": parse_json("KAZA_AUDIT_IMAGE_IDS", {}),
