...
15. API contract tests for all ten error codes (§14).
...
| AC-HB09-07 | All ten error codes in §14 are asserted by code, not by message text. |
...
All ten error codes; permission policies; response shape; `is_historical` present and defaulting false on
