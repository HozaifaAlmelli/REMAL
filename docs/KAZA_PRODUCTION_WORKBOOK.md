...
> 📚 فهرس التوثيق الكامل: [`docs/README.md`](README.md) — وفهرس العمليات:
...
| عندي DB migration | [القسم 11 (قاعدة البيانات)](#القسم-11--سير-عمل-قاعدة-البيانات-database-workflow) |
| عندي مشكلة nginx/SSL | [القسم 13 (SSL / nginx)](#القسم-13--سير-عمل-ssl--nginx) |
| عندي login freeze | [القسم 9 (البوابة)](#القسم-9--سير-عمل-البوابة-portal-workflow) + [كتاب الطوارئ 17.8](#178-تجمد-بعد-تسجيل-الدخول-login-freeze) |
| هدي access مؤقت لـ Agent | [القسم 16 (SSH المؤقّت)](#القسم-16--سير-عمل-وصول-ssh-المؤقت-temporary-ssh-access) |
| خلصت شغل | [القسم 8 (التحقق)](#القسم-8--قائمة-التحقق-القياسية-standard-verification-checklist) + [القسم 19 (قائمة المشغّل النهائية)](#القسم-19--قائمة-تحقق-المشغل-النهائية-final-operator-checklist) |
| حاجة اتكسرت دلوقتي (طوارئ) | [القسم 17 (كتب الطوارئ)](#القسم-17--كتب-الطوارئ-emergency-playbooks) |
...
if ! docker exec kaza-prod-db sh -lc '
  set -e
