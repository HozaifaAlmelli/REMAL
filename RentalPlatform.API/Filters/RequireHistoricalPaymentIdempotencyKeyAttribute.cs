...
public sealed class RequireHistoricalPaymentIdempotencyKeyAttribute : Attribute, IAsyncResourceFilter
{
    public const string ContextItemKey = "HistoricalPayment.IdempotencyKey";
