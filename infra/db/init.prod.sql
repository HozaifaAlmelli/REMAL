...
\echo '=== [prod] 0058: add historical booking domain ==='
...
\echo '=== [prod] 0061: add historical payment recording ==='
...
\echo '=== [prod] 0064: add rentable capacity history ==='
...
FROM unnest(ARRAY[
  ...
  '0053','0054','0055','0056','0057','0058','0059','0060','0061','0062','0063','0064'
]) AS n
